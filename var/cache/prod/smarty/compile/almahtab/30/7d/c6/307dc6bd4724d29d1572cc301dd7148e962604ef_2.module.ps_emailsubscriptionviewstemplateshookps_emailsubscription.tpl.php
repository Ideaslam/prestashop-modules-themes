...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_64fcd3f06a8ae9_84645935',
...
function content_64fcd3f06a8ae9_84645935 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
">
  <div class="row">
     ...
     <div class="col-xs-12 col-md-4 newsletter-label">
              <p id="block-newsletter-label" class="col-md-12 col-xs-12"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Get our latest news and special sales','d'=>'Shop.Theme.Global'),$_smarty_tpl ) );?>
</p>
              <?php if ($_smarty_tpl->tpl_vars['conditions']->value) {?>
                <p class="col-md-12 col-xs-12"><?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['conditions']->value, ENT_QUOTES, 'UTF-8');?>
</p>
              <?php }?>
             
              <?php if ($_smarty_tpl->tpl_vars['msg']->value) {?>
                <p class="alert <?php if ($_smarty_tpl->tpl_vars['nw_error']->value) {?>alert-danger<?php } else { ?>alert-success<?php }?> col-md-12 col-xs-12">
